...
func TestMessage(t *testing.T) {
	...
	testCertRaw, testKeyRaw, err := luxtls.NewCertAndKeyBytes()
	require.NoError(t, err)

	testTLSCert, err := luxtls.LoadTLSCertFromBytes(testKeyRaw, testCertRaw)
	require.NoError(t, err)
	...
	tests := []struct {
	...
	}{
		{
			...
			compressionType:  compress.TypeNone,
