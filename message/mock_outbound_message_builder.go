...
// Source: github.com/luxfi/p2p/message (interfaces: OutboundMsgBuilder)
//
// Generated by this command:
//
//	mockgen -package=message -destination=message/mock_outbound_message_builder.go github.com/luxfi/p2p/message OutboundMsgBuilder
//
